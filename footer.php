    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-lg-6">
                ...
                <ul class="contatos">
                    <li class="telefone"><?= get_theme_mod("telefone_contato_footer"); ?></li>
                    <li class="email"><?= get_theme_mod("email_contato_footer"); ?></li>
                    <li class="endereco"><?= get_theme_mod("endereço_contato_footer"); ?></li>
                </ul>
            </div>
