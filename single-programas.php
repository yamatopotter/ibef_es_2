    ...
    ?>
            ...
            <main>
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <?php while ($resenhas_query->have_posts()) : $resenhas_query->the_post(); ?>
                                    <div class="col-12 col-md-6 col-lg-3 mb-4">
                                        <div class="card">
                                            ...
                                            <div class="card-content">
                                                <div class="card-data">
                                                    <span class="card-category"><?= get_custom_category($post->ID, "resenhas-academy-category") ?></span>
                                ...
                                <div class="d-flex justify-content-center mt-4">
                                    <a href="<?= get_post_type_archive_link('resenhas-academy'); ?>" class="btn btn-primary">Ver mais resenhas <i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
                ...
                if (get_field("show_artigos_block_ibef_academy")) :
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-12 texto-center">
                                    <h2><?= get_field("title_artigos_ibef_academy") ?></h2>
                                </div>
                                ...
                                <?php endwhile; ?>
                                <div class="d-flex justify-content-center mt-4">
                                    <a href="<?= get_post_type_archive_link('artigos-academy'); ?>" class="btn btn-primary">Ver mais artigos <i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </section>
                <?php endif;
                wp_reset_postdata();
                if (get_field("show_artigos_block_cqc")) :

                    $artigos_cqc_query = new WP_Query(array(
                ...
                ?>
                    <section id="ultimas-noticias">
                        <div class="container">
                            <h2 class="title"><?= the_field("title_artigos_cqc") ?></h2>

                            <div class="row">
                                <?php while ($artigos_cqc_query->have_posts()) : $artigos_cqc_query->the_post(); ?>
                                    <div class="col-12 col-md-6 col-lg-3 mb-4">
                                        <div class="card">
                                ...
                                <div class="d-flex justify-content-center mt-4">
                                    <a href="<?= get_post_type_archive_link('artigos-cqc'); ?>" class="btn btn-primary">Ver mais artigos <i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
