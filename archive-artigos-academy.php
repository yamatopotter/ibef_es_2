    ...
    <main>
        <?php if (empty(get_theme_mod("background_archive_artigos"))) : ?>
            <section id="intro-sub">
            <?php else : ?>
                <section id="intro-sub" style="background: url(<?php echo get_theme_mod("background_archive_artigos") ?>) no-repeat center center/cover">
                <?php endif; ?>
                <div class="container">
