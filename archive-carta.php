...
<main>
    ...
    <?php if (empty(get_theme_mod("background_archive_cartas"))) : ?>
        <section id="intro-sub">
        <?php else : ?>
            <section id="intro-sub" style="background: url(<?= get_theme_mod("background_archive_cartas") ?>) no-repeat center center/cover">
            <?php endif; ?>
            <div class="container">
